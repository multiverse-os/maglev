...
replace (
	github.com/multiverse-os/cli/data v0.1.0 => github.com/multiverse-os/data v0.1.0
	github.com/multiverse-os/cli/terminal/ansi v0.1.0 => github.com/multiverse-os/ansi v0.1.0
	github.com/multiverse-os/cli/terminal/loading v0.1.0 => github.com/multiverse-os/loading v0.1.0
	github.com/multiverse-os/cli/terminal/text/banner v0.1.0 => github.com/multiverse-os/banner v0.1.0
)
