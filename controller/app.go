...
func (c Actions) Root(body http.ResponseWriter, request *http.Request) {
	...
	// TODO: This should be like render and possibly we want to make a function
	// so we can output as XML, JSON, etc
